...
- Versione reale del codice: `1.7.26` per la PWA/offline-first.
- `README.md`, `VERSION`, `manifest.webmanifest`, `manifest.json`, `sw.js` e `app-v13.js` sono allineati a `1.7.26`.
...
- La versione `1.7.26` protegge le rimozioni locali con una conferma condivisa, rende le azioni modificabili solo dopo il comando Modifica e porta il cambio tema nel menu mobile.
...
- `manifest.webmanifest`: manifest PWA aggiornato a `1.7.26`.
...
- `sw.js` e' passato a cache `dnd-pwa-v1.7.26`;
